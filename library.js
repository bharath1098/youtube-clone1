...
const searchInput=document.getElementById("search");
    ...
    async function loadData(searchString){
      ...
      loadLibraryVideoBasedOnVideosList(data);
    } 
    ...
    async function loadLibraryData(e){
     ...
     async function loadLibraryVideoBasedOnVideosList(data){
      //remove previous data 
      library_video_container.innerHTML="";
    ...
    await  videoCard.addEventListener("mouseleave",()=>{
      ...
      const time=document.createElement("div");
            ...
            library_video_container.appendChild(videoCard);

...
const movies_and_show=document.getElementById("movies and shows");
...
const searchInput=document.getElementById("search");
    ...
    async function loadSubscriptionData(e){
          e.preventDefault();
      const searchString="new movies and shows videos";
    ...
    await  videoCard.addEventListener("mouseleave",()=>{
      ...
      movies_and_show.addEventListener("click",loadSubscriptionData);      

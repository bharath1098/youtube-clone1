...
const kids_zone_btn=document.getElementById("kids zone");
...
const searchInput=document.getElementById("search");
    ...
    async function loadSubscriptionData(e){
          e.preventDefault();
      const searchString="cartoons videos and rhymes videos for kids";
    ...
    await  videoCard.addEventListener("mouseleave",()=>{
     ...
     kids_zone_btn.addEventListener("click",loadSubscriptionData);      

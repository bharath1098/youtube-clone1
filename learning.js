...
const learning_btn=document.getElementById("learning");
...
const searchInput=document.getElementById("search");
    ...
    async function loadSubscriptionData(e){
          e.preventDefault();
      const searchString="new and future technologies  in the world";
    ...
    await  videoCard.addEventListener("mouseleave",()=>{
     ...
     learning_btn.addEventListener("click",loadSubscriptionData);      

...
const searchInput=document.getElementById("search");
    ...
    async function loadData(searchString){
      ...
      loadHistoryVideoBasedOnVideosList(data)
    } 
   ...
   async function loadHistoryVideoBasedOnVideosList(data){
       //remove previous data 
       left_history_video_container.innerHTML="";
       ...
       videoCard.className="hs-video";
          
         const video_img_container=document.createElement("div");
          video_img_container.className="hs-video_image_container";
          const thumbnailElement=document.createElement("img");
          thumbnailElement.className="hs-thumbnail";
     ...
     await  videoCard.addEventListener("mouseleave",()=>{
      ...
      const channel_Name=document.createElement("span");
       ...
       left_history_video_container.appendChild(videoCard);
